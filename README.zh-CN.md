...
<table>
  <tr>
    <td><img src="docs/screenshots/codex-dashboard.png" alt="Codex 视图——同一个控制台,独立的 URL 空间与视觉" /></td>
...
**co**·**co**·**pit**:Claude **Co**de 的 co,加 **Co**dex 的 co,两个 co 共用一个 pit(坑)——合起来是 **cockpit**(驾驶舱),同时驾驭两者;中文名「可可坑」,一个装满可可果的坑,恰好也是 logo 画的东西。每一层含义都是故意的。
