...
const EN: Record<string, string> = {
  ...
  "监听地址": "Bind address",
  "仅本机 (127.0.0.1)": "This machine only (127.0.0.1)",
  "所有网卡 (0.0.0.0)": "All interfaces (0.0.0.0)",
  "指定地址…": "Specific address…",
  "需要先设置访问令牌": "Set an access token first",
  "允许来源": "Allowed origins",
  "反代域名,每行一个。留空表示只允许本机来源。": "Reverse-proxy domains, one per line. Empty means same-origin only.",
  "当前监听": "Currently bound to",
  "已保存并生效。": "Saved and applied.",
  "已保存,但切换监听地址失败:{err}。旧地址仍在服务。":
    "Saved, but moving the listener failed: {err}. The previous address is still serving.",
  "改为对外地址后,请用新地址访问;本页面仍连在旧地址上。":
    "After binding to an external address, use that address; this page is still connected to the old one.",
  "已保存。": "Saved.",
  ...
  "CLI 调试日志,删除不影响会话记录": "CLI debug logs; deleting them does not affect session transcripts",
  "按会话保存的文件改动快照,用于会话内撤销": "Per-session snapshots of file edits, used for in-session undo",
  "会话临时环境,多为空目录": "Temporary session environments, mostly empty directories",
  "插件安装过程遗留的临时 git 克隆": "Temporary git clones left behind by plugin installs",
  "shell 环境快照": "Shell environment snapshots",
  "会话任务列表缓存": "Cached session task lists",
  "会话记录": "Session transcripts",
  "活跃会话注册表": "Active session registry",
  "默认账号": "Default account",
  "订阅开始": "Subscription started",
  "试用到期": "Trial ends",
  "额外用量": "Extra usage",
  "已开启": "Enabled",
  "未开启": "Disabled",
  ...
  "还没有方案。": "No presets yet.",
  "{n} 项设置": "{n} settings",
  "套用": "Apply",
  "与当前一致": "Already current",
  "已套用": "Applied",
  "已删除": "Deleted",
  "已备份": "backup",
  "将改动": "changes",
